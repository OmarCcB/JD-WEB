...
# =========================================================
# ROOT → redirige siempre al portal
# =========================================================
@app.get("/")
def root():
...
def portal_token(token: str):
    ...
    # ⚠️ IMPORTANTE:
    # - Cloudflare termina HTTPS → secure=True funciona
    # - En local sin https, usar secure=False
    resp.set_cookie(
        key=COOKIE_NAME,
        value=cookie_val,
        httponly=True,
